                        ...
                        <div class="sticky-content-inner">
                            <div class="post--item post--single post--title-largest pd--30-0">
                                <div class="post--img"> <a href="#" class="thumb"><img
                                            src="img/news-single-img/post-img-01.jpg" alt=""></a> <a href="#"
                                ...
                                <div class="post--info">
                                    ...
                                    <div class="title">
                                        <h2 class="h4">It is a long established fact that a reader will be distracted by
                                            the readable content</h2>
                                    </div>
                                </div>
                                <div class="post--content">
                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority
                                        ...
                                        The generated Lorem Ipsum is therefore always free from repetition words etc.
                                    </p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"> <img src="img/news-single-img/post-img-02.jpg" alt="">
                                    ...
                                    <blockquote>
                                        <p>It is a long established fact that a reader will be distracted by the
                                            ...
                                            Lorem Ipsum is that it has a more-or-less normal making it look like
                            ...
                            <div class="post--related ptop--30">
                                <div class="post--items-title" data-ajax="tab">
                                    ...
                                    <div class="nav"> <a href="#" class="prev btn-link"
                                            data-ajax-action="load_prev_related_posts"> <i
                                    ...
                                    <ul class="nav row" data-ajax-content="inner">
                                        <li class="col-sm-6 pbottom--30">
                                            <div class="post--item post--layout-1">
                                                <div class="post--img"> <a href="#" class="thumb"><img
                                                            src="img/news-single-img/related-post-01.jpg" alt=""></a> <a
                                                        href="#" class="cat">Fitness</a> <a href="#" class="icon"><i
                                                    ...
                                                    <div class="post--info">
                                                        ...
                                                        <div class="title">
                                                            <h3 class="h4"><a href="#" class="btn-link">On the other
                                                                    hand, we denounce with righteous indignation and
                                                                    dislike demoralized</a></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="post--content">
                                        ...
                                        <li class="col-sm-6 hidden-xs pbottom--30">
                                            <div class="post--item post--layout-1">
                                                <div class="post--img"> <a href="#" class="thumb"><img
                                                            src="img/news-single-img/related-post-02.jpg" alt=""></a> <a
                                                        href="#" class="cat">Fitness</a> <a href="#" class="icon"><i
                                                            class="fa fa-flash"></i></a>
                                                    <div class="post--info">
                                                        <ul class="nav meta">

...
<!-- Mirrored from themelooks.us/demo/usnews/html/home-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Aug 2023 07:31:53 GMT -->
                        ...
                        <ul class="nav row" data-ajax-content="inner">
                            <li class="col-md-8">
                                <div class="post--item post--layout-1 post--type-video post--title-large">
                                    ...
                                    <div class="post--img">
                                        <img src="./assets/img/<?= $row['image'] ?>" alt="" name="image" id="img" style="margin: 0px 80px; width: -webkit-fill-available;
    height: 365px;border-radius:5px" />

                                        <!-- <a href="#" class="cat">Wave</a>
                                        <a href="#" class="icon"><i class="fa fa-eye"></i></a> -->
                                        <a href="#"><?= $row['createdat'] ?></a>
                                        <div class="post--info">
                                            <ul class="nav meta">
                                            ...
                                            <div class="title">
                                                <h2 class="h4"><a href="news-detail.php?news_id=<?= $row['news_id'] ?>" class="btn-link"><?= $row['title'] ?>
                                                    </a></h2>
                                            </div>
                                        </div>
                                    </div>

                                    <!-- <div class=""> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/photo-gallery-01.jpg"
                                                                alt=""></a> <a href="#" class="cat">Serfer</a> <a
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title text-xxs-ellipsis">
                                                                <h2 class="h4"><a href="news-detail.php"
                                    ...
                                    ?>
                                        <li>
                                            <div class="post--item post--type-audio post--layout-3">
                                                <div class="post--img"> <a href="news-detail.php?news_id=<?= $row['news_id'] ?>" class="thumb"><img src="./assets/img/<?= $row['image'] ?>" alt="" name="image" id="img" /></a>
                                                    <div class="post--info">
                                                        <ul class="nav meta">
                                                        ...
                                                        <div class="title">
                                                            <h3 class="h4"><a href="news-detail.php?news_id=<?= $row['news_id'] ?>" class="btn-link"><?= $row['title'] ?></a></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav"> <a href="#" class="prev btn-link"
                                                data-ajax-action="load_prev_world_news_posts"> <i
                                                    class="fa fa-long-arrow-left"></i> </a> <span
                                                class="divider">/</span> <a href="#" class="next btn-link"
                                                data-ajax-action="load_next_world_news_posts"> <i
                                        ...
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            <li class="col-xs-12">
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/world-news-01.jpg"
                                                                alt=""></a> <a href="#" class="cat">War</a> <a href="#"
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-detail.php"
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/world-news-02.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/world-news-03.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/world-news-04.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/world-news-05.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Hantu Raya</a></li>
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav"> <a href="#" class="prev btn-link"
                                                data-ajax-action="load_prev_technology_posts"> <i
                                                    class="fa fa-long-arrow-left"></i> </a> <span
                                                class="divider">/</span> <a href="#" class="next btn-link"
                                                data-ajax-action="load_next_technology_posts"> <i
                                                    class="fa fa-long-arrow-right"></i> </a> </div>
                                    </div>
                                    <div class="post--items post--items-3" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
                                            <li>
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/technology-01.jpg"
                                                                alt=""></a> <a href="#" class="cat">Computer</a> <a
                                                            href="#" class="icon"><i class="fa fa-heart-o"></i></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-detail.php"
                                                                        class="btn-link">It is a long established fact
                                                                        that a reader will be distracted by</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/technology-02.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bune</a></li>
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-detail.php"
                                                                        ...
                                                                        reader will be distracted by the readable</a>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/technology-03.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bune</a></li>
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/technology-04.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bune</a></li>
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/technology-05.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bune</a></li>
                                ...
                                <div class="col-md-12 ptop--30 pbottom--30">
                                    <div class="ad--space"> <a href="#"> <img src="img/ads-img/ad-728x90-01.jpg" alt=""
                                ...
                                <div class="col-md-12 ptop--30 pbottom--30">
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav"> <a href="#" class="prev btn-link"
                                                data-ajax-action="load_prev_finance_posts"> <i
                                                    class="fa fa-long-arrow-left"></i> </a> <span
                                                class="divider">/</span> <a href="#" class="next btn-link"
                                                data-ajax-action="load_next_finance_posts"> <i
                                                    class="fa fa-long-arrow-right"></i> </a> </div>
                                    </div>
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav row" data-ajax-content="inner">
                                            <li class="col-md-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/finance-01.jpg"
                                                                alt=""></a> <a href="#" class="cat">Business</a> <a
                                                            href="#" class="icon"><i class="fa fa-star-o"></i></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                            ...
                                            <li class="col-md-6">
                                                <ul class="nav row">
                                                    ...
                                                    <li class="col-xs-6">
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img"> <a href="news-detail.php"
                                                                    class="thumb"><img src="img/home-img/finance-02.jpg"
                                                                        alt=""></a>
                                                                <div class="post--info">
                                                                    <ul class="nav meta">
                                                    ...
                                                    <li class="col-xs-6">
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img"> <a href="news-detail.php"
                                                                    class="thumb"><img src="img/home-img/finance-03.jpg"
                                                                        alt=""></a>
                                                                <div class="post--info">
                                                                    <ul class="nav meta">
                                                    ...
                                                    <li class="col-xs-6">
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img"> <a href="news-detail.php"
                                                                    class="thumb"><img src="img/home-img/finance-04.jpg"
                                                                        alt=""></a>
                                                                <div class="post--info">
                                                                    <ul class="nav meta">
                                                                        <li><a href="#">Demiurge</a></li>
                                                    ...
                                                    <li class="col-xs-6">
                                                        <div class="post--item post--layout-2">
                                                            <div class="post--img"> <a href="news-detail.php"
                                                                    class="thumb"><img src="img/home-img/finance-05.jpg"
                                                                        alt=""></a>
                                                                <div class="post--info">
                                                                    <ul class="nav meta">
                                                                        <li><a href="#">Zepar</a></li>
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav"> <a href="#" class="prev btn-link"
                                                data-ajax-action="load_prev_politics_posts"> <i
                                                    class="fa fa-long-arrow-left"></i> </a> <span
                                                class="divider">/</span> <a href="#" class="next btn-link"
                                                data-ajax-action="load_next_politics_posts"> <i
                                                    class="fa fa-long-arrow-right"></i> </a> </div>
                                    </div>
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            <li class="col-xs-12">
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/politics-01.jpg"
                                                                alt=""></a> <a href="#" class="cat">Election</a> <a
                                                            href="#" class="icon"><i class="fa fa-fire"></i></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                                                <li><a href="#">Yeasterday 03:52 pm</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/politics-02.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Hantu Raya</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/politics-03.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/politics-04.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/politics-05.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Hantu Raya</a></li>
                                ...
                                <div class="col-md-6 ptop--30 pbottom--30">
                                    <div class="post--items-title" data-ajax="tab">
                                        ...
                                        <div class="nav"> <a href="#" class="prev btn-link"
                                                data-ajax-action="load_prev_sports_posts"> <i
                                                    class="fa fa-long-arrow-left"></i> </a> <span
                                                class="divider">/</span> <a href="#" class="next btn-link"
                                                data-ajax-action="load_next_sports_posts"> <i
                                                    class="fa fa-long-arrow-right"></i> </a> </div>
                                    </div>
                                    <div class="post--items post--items-3" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
                                            <li>
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/sports-01.jpg"
                                                                alt=""></a> <a href="#" class="cat">Basketball</a> <a
                                                            href="#" class="icon"><i class="fa fa-eye"></i></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bathin</a></li>
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/sports-02.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bune</a></li>
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/sports-03.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bune</a></li>
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/sports-04.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bune</a></li>
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/sports-05.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Bune</a></li>
                    ...
                    <div class="main--sidebar col-md-4 col-sm-5 ptop--30 pbottom--30" data-sticky-content="true">
                        <div class="sticky-content-inner">
                            ...
                            <div class="widget">
                                ...
                                <div class="social--widget style--5">
                                    <ul class="nav">
                            ...
                            <div class="widget">
                                ...
                                <div class="subscribe--widget">
                                    <form
                                        ...
                                        data-form="mailchimpAjax" novalidate="novalidate"> <input type="text"
                                            name="MERGE1" placeholder="First Name" class="form-control"
                                            autocomplete="off" required> <input type="text" name="MERGE2"
                                            placeholder="Last Name" class="form-control" autocomplete="off" required>
                                        <input type="email" name="EMAIL" placeholder="E-mail address"
                                            class="form-control" autocomplete="off" required> <button type="submit"
                                            class="btn btn-lg btn-block btn-default active">Subscribe</button>
                                    ...
                                    <div class="list--widget-nav" data-ajax="tab">
                                        <ul class="nav nav-justified">
                                            ...
                                            <li class="active"> <a href="#"
                                                    data-ajax-action="load_widget_trendy_news">Trendy News</a> </li>
                                    ...
                                    <div class="post--items post--items-3" data-ajax-content="outer">
                                        <ul class="nav" data-ajax-content="inner">
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/widgets-img/news-widget-01.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/widgets-img/news-widget-02.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/widgets-img/news-widget-03.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/widgets-img/news-widget-04.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                ...
                                ?>
                                    <div class="col-md-6 ptop--30 pbottom--30">
                                        ...
                                        <div class="post--items-title" data-ajax="tab">
                                            ...
                                            <?php
                                            $resultss = $news->getnewsbycategoryname($rows['category_id']);
                                            if (!$resultss)
                                        ...
                                        <div class="post--items post--items-3" data-ajax-content="outer">
                                            <ul class="nav" data-ajax-content="inner">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="post--item post--layout-1">
                                                        <div class="post--img"> <a href="news-detail.php?news_id=<?= $row['news_id'] ?>" class="thumb">
                                                                <img src="./assets/img/<?= $rowss['image'] ?>" alt="" style="height:150px;">
                                                            </a>
                                                            <!-- <a href="#" class="cat">Business</a> <a href="#" class="icon"><i class="fa fa-star-o"></i></a> -->
                                                            <div class="post--info">
                                                                <ul class="nav meta">

                                                                </ul>
                                                                <div class="title">
                                                                    <h3 class="h4"><a href="news-detail.php?news_id=<?= $rowss['news_id'] ?>" class="btn-link" style="color:red !important;"><?= $rowss['title'] ?></a></h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li>
                                                    ...
                                                    ?>
                                                        <div class="post--item post--layout-3">
                                                            <div class="post--img"> <a href="news-detail.php?news_id=<?= $rowss['news_id'] ?>" class="thumb"><img src="./assets/img/<?= $rowss['image'] ?>" alt=""></a>
                                                                <div class="post--info">
                                                                    <ul class="nav meta">
                                                                        <!-- <li><a href="#">Maclaan John</a></li> -->
                                                                        <li><a href="#"><?= $rowss['createdat'] ?></a></li>
                                                                    </ul>
                                                                    <div class="title">
                                                                        <h3 class="h4"><a href="news-detail.php?news_id=<?= $rowss['news_id'] ?>" class="btn-link"><?= $rowss['title'] ?></a>
                                                                        </h3>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <!-- <div class="col-md-6 ptop--30 pbottom--30">
                                    ...
                                    <div class="post--items post--items-2" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            <li class="col-xs-12">
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img"> <a href="news-detail.php" class="thumb"><img src="img/home-img/lifestyle-01.jpg" alt=""></a> <a href="#" class="cat">Fashion</a> <a href="#" class="icon"><i class="fa fa-heart-o"></i></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                                                <li><a href="#">Yeasterday 03:52 pm</a></li>
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-detail.php" class="btn-link">Siriya attaced by a long
                                                                        established fact that a reader will be
                                                                        distracted by</a></h3>
                                                            </div>
                                                        </div>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php" class="thumb"><img src="img/home-img/lifestyle-02.jpg" alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                                                <li><a href="#">17 April 2017</a></li>
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="news-detail.php" class="btn-link">It is a long established fact
                                                                        that a reader will done</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php" class="thumb"><img src="img/home-img/lifestyle-03.jpg" alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                                                <li><a href="#">17 April 2017</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php" class="thumb"><img src="img/home-img/lifestyle-04.jpg" alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                                                <li><a href="#">17 April 2017</a></li>
                                            ...
                                            <li class="col-xs-6">
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img"> <a href="news-detail.php" class="thumb"><img src="img/home-img/lifestyle-05.jpg" alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                                                <li><a href="#">17 April 2017</a></li>
                                    ...
                                    <div class="post--items post--items-1" data-ajax-content="outer">
                                        <ul class="nav row gutter--15" data-ajax-content="inner">
                                            ...
                                            <li class="col-md-4 col-xs-6 col-xxs-12">
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/photo-gallery-02.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                                            ...
                                                            <div class="title">
                                                                <h2 class="h4"><a href="news-detail.php"
                                                                        class="btn-link">It is a long established fact
                                                                        that a reader will be distracted by</a></h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <li class="col-md-4 col-xs-6 col-xxs-12">
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/photo-gallery-03.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                            ...
                                            <li class="col-md-4 hidden-sm hidden-xs">
                                                <div class="post--item post--layout-1">
                                                    <div class="post--img"> <a href="news-detail.php"
                                                            class="thumb"><img src="img/home-img/photo-gallery-04.jpg"
                                                                alt=""></a>
                                                        <div class="post--info">
                                                            <ul class="nav meta">
                                                                <li><a href="#">Astaroth</a></li>
                                    ...
                                    <div class="post--items post--items-3">
                                        <ul class="nav" data-ajax-content="inner">
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <span class="thumb"><img
                                                                src="img/widgets-img/readers-opinion-01.png"
                                                                alt=""></span>
                                                        <div class="post--info">
                                                            <div class="title">
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <span class="thumb"><img
                                                                src="img/widgets-img/readers-opinion-02.png"
                                                                alt=""></span>
                                                        <div class="post--info">
                                                            <div class="title">
                                                                <h3 class="h4">Long established fact that a reader will
                                            ...
                                            <li>
                                                <div class="post--item post--layout-3">
                                                    <div class="post--img"> <span class="thumb"><img
                                                                src="img/widgets-img/readers-opinion-03.png"
                                                                alt=""></span>
                                                        <div class="post--info">
                                                            <div class="title">
                                                                <h3 class="h4">Long established fact that a reader will
